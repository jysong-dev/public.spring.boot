...
<div class="container-fluid p-0">
					...
					<div class="row">
						<div class="col-12 col-md-6 col-lg-4">
							<div class="card">
								<img class="card-img-top" src="${contextPath}/resources/lib/adminkit-master/static/img/photos/unsplash-1.jpg" alt="Unsplash">
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="card">
								<img class="card-img-top" src="${contextPath}/resources/lib/adminkit-master/static/img/photos/unsplash-2.jpg" alt="Unsplash">
								<div class="card-header">
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="card">
								<img class="card-img-top" src="${contextPath}/resources/lib/adminkit-master/static/img/photos/unsplash-3.jpg" alt="Unsplash">
								<div class="card-header">
